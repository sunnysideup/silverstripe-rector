...
final class SilverstripeLevelSetList
{
    ...
    public const UP_TO_SS_4_3 = __DIR__ . '/../../config/level/up-to-silverstripe-4-3.php';

    public const UP_TO_SS_4_4 = __DIR__ . '/../../config/level/up-to-silverstripe-4-4.php';

    public const UP_TO_SS_4_5 = __DIR__ . '/../../config/level/up-to-silverstripe-4-5.php';

    public const UP_TO_SS_4_6 = __DIR__ . '/../../config/level/up-to-silverstripe-4-6.php';

    public const UP_TO_SS_4_7 = __DIR__ . '/../../config/level/up-to-silverstripe-4-7.php';

    public const UP_TO_SS_4_8 = __DIR__ . '/../../config/level/up-to-silverstripe-4-8.php';

    public const UP_TO_SS_4_9 = __DIR__ . '/../../config/level/up-to-silverstripe-4-9.php';

    public const UP_TO_SS_4_10 = __DIR__ . '/../../config/level/up-to-silverstripe-4-10.php';
    ...
    public const UP_TO_SS_6_0_ADDITIONAL = __DIR__ . '/../../config/level/silverstripe-6-0-additional-run-once.php';
    public const UP_TO_SS_6_0_PAGE_CMS_FIELDS = __DIR__ . '/../../config/level/silverstripe-6-0-page-cms-fields-run-once.php';
}
