...
final class RenamedParameter extends AbstractScopeAwareRector implements ConfigurableRectorInterface
{
    /**
    ...
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition(
            'Adds TODO upgrade comments for method calls/overrides where a parameter was renamed.',
            [
...
$service->run($request);
CODE_SAMPLE,
                    [['c' => 'BuildTask', 'm' => 'run', 'n' => 'Renamed parameter $request in BuildTask::run() to $input', 'u' => false]]
                ),
            ]
        );
    }
